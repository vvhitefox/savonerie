<?php include_once("header.php"); ?>
			...
			<div id="carouselExampleIndicators" class="carousel slide shadow-sm" data-ride="carousel">
			  ...
			  <div class="carousel-inner">
			    <div class="carousel-item active">
			      <img src="img/alala.jpg" class="d-block w-100 img-fluid img-carousel" alt="...">
	...
	<div class="row bg-1 h-100">
		<div class="col-lg-4 offset-lg-2 col-8 offset-2 mt-5 mb-5 text-center my-auto">
			<h2>Produits haute qualité</h2>

			<p class="mt-3 mb-3 text-left">Nous travaillons avec des huiles, des beurres, des huiles essentielles bio et des argiles qui sont totalement naturels. Tous les ingrédients utilisés dans les savons sont choisis pour leurs propriétés et leur qualité.</p>
		</div>

		<div class="col-lg-4 col-8 mt-5 mb-5">
			<img src="img/alala.jpg" class="d-block w-100 img-fluid img-carousel" alt="...">
		</div>
	</div>

	<div class="row bg-2 h-100">
		<div class="col-lg-4 offset-lg-2 col-8 mt-5 mb-5">
			<img src="img/alala.jpg" class="d-block w-100 img-fluid img-carousel" alt="...">
		</div>

		<div class="col-lg-4 col-8 mt-5 mb-5 text-center my-auto">
			<h2>Respect de la peau</h2>
			<p class="text-left mt-3 mb-3">La méthode de saponification à froid permet de préserver les vertus les ingrédients, nos produits sont respectueux de la peau en protégeant le film hydrolipidique. Un surgras de 6% minimum est ajouté à chaque produit de la gamme pour apporter une propriété particulière à chaque savon. 
	...
	<div class="row h-100">
		<div class="col-lg-4 offset-lg-2 col-8 offset-2 mt-5 mb-5 text-center my-auto">
			...
			<h2 class="mt-5 mb-5">Engagement / Eveil des consciences</h2>
			<h2 class="mt-5 mb-5">Respect de L’humain et son environnement : Entreprise éco-responsable</h2>
			...
			<h2 class="mt-5 mb-5">Zéro déchets</h2>
			<p class="text-left mt-3 mb-3">Avec un savon à froid, vous adoptez une démarche « zéro-déchet » et évitez de remplir vos poubelles de flacons plastiques.</p>

			<h2 class="mt-5 mb-5">Réglementation / Formation</h2>
